...
|Product| has two RJ45 connectors that provide up to 1 Gbps data rates over Ethernet :numref:`(Figure %s) <F7>`. These GbE interfaces support some advanced features such as 
auto-negotiation and Wake on LAN, but do not support Power over Ethernet (PoE).
...
The outer mechanical dimensions of |product| are 272 x 221 x 53mm (W x L x H). |Product| supports VESA 100 x 100 mounting pattern with 4 x M4 screws, enabling simplified installation onto any standard vesa mounting rack. 
Pleae refer to the technical drawing in the :numref:`(Figure %s) <F9>` for details related to the specific product measurements. 
