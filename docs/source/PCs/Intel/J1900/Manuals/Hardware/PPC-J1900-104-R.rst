...
.. figure:: /Media/Intel/J1900/PPC-J1900-104-R_Rear_690.png
   :align: center
   :figclass: align-center
...
There are many connectivity options available on the |product| industrial PC. It has 4 x USB ports, 1 x HDMI port, 2 x RJ45 connectors supporting Gigabit Ethernet (GbE), and up to 
4 x RS232 connectors, of which two can be configured in RS485 mode. There are also 8 x GPIO channels for various user-defined purposes.
...
.. figure:: /Media/Intel/J1900/PPC-J1900-104-Con_950.png
   ...
   Connectivity Section: Two D-sub + 16-pin Double Row Terminal Block
