...
throughput, please use CAT 5E Ethernet cables with the maxumum lenght supported by the standard (100m). The integrated Ethernet dual-port interface supports auto-speed
